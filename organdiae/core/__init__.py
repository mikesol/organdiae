...
__init__.py: module init file for core
...
from core import *
from collection import Collection, CFunction
from polynomial import Polynomial, Impulse, PiecewisePolynomial, DeltaFunction
